...
const RecentOrders = () => {
  return (
    <div className='rounded px-3 py-3 ms-md-3 mt-4 mt-md-0' style={{backgroundColor:"#292A31"}}>
            ...
            <tr key={index} style={{fontSize: '14px'}}>
              <td>
                <div className='d-flex align-items-center'>
                  <img className='profile-img rounded-circle me-2' style={{width: '30px', height: '30px', objectFit: 'cover'}} />
                  <span>{item.name}</span>
                </div>
              </td>
              <td>{item.number}</td>
              ...
              <td>
                <span className='px-2 py-1 rounded-pill' style={{
                  backgroundColor: item.status === "Delivered" ? "#22C55E" : 
                                   item.status === "Pending" ? "#EAB308" : "#EF4444",
                  color: "white",
                  fontSize: '12px'
                }}>
                  {item.status}
